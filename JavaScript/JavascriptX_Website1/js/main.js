...
// ul2.lastElementChild.textContent="item text content changed";
// ul2.children[1].innerText="item inner text changed";
// ul2.firstElementChild.innerHTML="<h1>item inner html changed</h1>";
...
// const btn1=document.querySelector(".butoon");
...
// 	document.querySelector(".items").lastElementChild.innerHTML="<h1 style='color:red'>changed after submit </h1>"
...
// 	document.querySelector("body").classList.add("dark-background");
// 	document.querySelector(".items").lastElementChild.innerHTML="<h1 style='color:green'>changed after submit </h1>"
...
// 	document.querySelector("body").classList.add("dark-background");
// 	document.querySelector(".items").lastElementChild.innerHTML="<h1 style='color:yellow'>changed after submit </h1>"
...
myform.addEventListener("submit", onSubmitCallMe3);

function onSubmitCallMe1(event){
	event.preventDefault();
...
function onSubmitCallMe2(event){
	event.preventDefault();
	...
	if(nameInput.value===''|| emailInput.value===''){
		msgElement.textContent="please enter values";
	}
	setTimeout(()=>msgElement.remove(), 3000);
}

function onSubmitCallMe3(event){
	event.preventDefault();
